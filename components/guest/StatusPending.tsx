...
export default function StatusPending({
  ...
  // Call Ready state (ডিফল্টভাবে false রাখা হয়েছে)
  const [isCallReady, setIsCallReady] = useState(false);
  const [vetName, setVetName] = useState('Dr. Sarah Jenkins');

  // সিমুলেট করার জন্য ৫ সেকেন্ড পর অটোমেটিক Call Ready করার একটি ডেমো ইফেক্ট
  // (আপনার রিয়েল ব্যাকএন্ড/সোকেট ডেটা আসলে এটি দিয়ে আপডেট করবেন)
  useEffect(() => {
    const timer = setTimeout(() => {
      setIsCallReady(true);
    }, 5000); // ৫ সেকেন্ড পর Call Ready হবে
